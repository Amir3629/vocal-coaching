  ...
  return (
    <>
      ...
      <p>
        ...
        Melanie Wainwright Vocal Coaching<br />
        Torstraße 177<br />
        10115 Berlin<br />
        E-Mail: contact@melaniewainwright.de
      </p>
      ...
      <p>
        Einige Cookies sind "Session-Cookies", die nach Ende Ihrer Browser-Sitzung automatisch gelöscht werden. Andere Cookies bleiben auf Ihrem Endgerät gespeichert, bis Sie diese löschen.
      </p>
      ...
      <p>
        Bei der Buchung von Unterrichtsstunden erheben wir die für die Vertragsabwicklung notwendigen Daten. Pflichtangaben sind als solche gekennzeichnet, weitere Angaben sind freiwillig.
      </p>
      ...
      <p>
        Wir setzen technische und organisatorische Sicherheitsmaßnahmen ein, um Ihre Daten gegen Manipulationen, Verlust, Zerstörung oder gegen den Zugriff unberechtigter Personen zu schützen.
      </p>
