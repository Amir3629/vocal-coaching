...
export default function ServiceCard({ title, description, icon, price, features, details, image, delay = 0 }: ServiceCardProps) {
  ...
  return (
    ...
    >
      <motion.div
        className="relative w-full rounded-2xl overflow-hidden h-[420px]"
        animate={{ 
      ...
      >
        ...
        {/* Content Layer */}
        <div className="relative h-full border border-[#C8A97E]/20 hover:border-[#C8A97E]/50 rounded-2xl overflow-hidden">
          <div className="p-6">
            {/* Title and Icon */}
