            ...
            >
              ...
              >
                ...
                <div className="absolute inset-0 backface-hidden">
                  <div className="h-full bg-[#0A0A0A] border border-[#C8A97E]/20 rounded-xl p-6 flex flex-col items-center justify-center">
                    ...
                    <h3 className="text-lg font-medium text-white text-center mb-2">{cert.title}</h3>
                    <p className="text-sm text-[#C8A97E]">{cert.year}</p>
                  </div>
                </div>

                {/* Back of card */}
                <div className="absolute inset-0 backface-hidden rotate-y-180">
                  <div className="h-full bg-[#0A0A0A] border border-[#C8A97E]/20 rounded-xl p-6 flex flex-col">
                    <h3 className="text-lg font-medium text-white mb-2">{cert.title}</h3>
                    <p className="text-sm text-[#C8A97E] mb-4">{cert.organization}</p>
                    <p className="text-sm text-gray-400 flex-grow">{cert.description}</p>
                    <a
                      href={cert.link}
                      target="_blank"
