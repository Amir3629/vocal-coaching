  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-[#C8A97E] text-slate-900 hover:bg-[#C8A97E] hover:text-slate-900 focus:bg-[#C8A97E] focus:text-slate-900 dark:bg-[#C8A97E] dark:text-slate-900 dark:hover:bg-[#C8A97E] dark:hover:text-slate-900 dark:focus:bg-[#C8A97E] dark:focus:text-slate-900",
